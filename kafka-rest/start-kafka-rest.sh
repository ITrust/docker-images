...
rp_cfg_file="${CONFLUENT_HOME}/etc/kafka-rest/kafka-rest.properties"

: ${RP_ID:=1}
: ${RP_PORT:=9082}
: ${RP_SCHEMA_REGISTRY_URL:=http://kafka-schema:9081}
...
exec ${CONFLUENT_HOME}/bin/kafka-rest-start ${rp_cfg_file}
